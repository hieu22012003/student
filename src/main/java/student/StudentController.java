...
public class StudentController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        list.add(new Student("Nguyen Trung Hieu","hieunt@gmail.com",1));
        list.add(new Student("Pham The Bach","bachpt@gmail.com",2));
        lv.setItems(list);
    }
    ...
    public void addStudent(){
       try {
           ...
           if(txtName.getText().isEmpty() || txtEmail.getText().isEmpty()
               ...
               throw new Exception("Vui long nhap cac thong tin hop le");
           }
